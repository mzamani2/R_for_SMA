...
In the first tutorial you performed a (quick) validation of the OBI4wan sentiment analysis tool. 
...
# Rule based versus supervised machine learning
...
We can now make the [same table that we used in the second tutorial](https://docs.google.com/spreadsheets/d/14_wsrN8ye93GnRZS6M_0vCJVkuVH5BCZ_a2EpKCLIjI/edit#gid=0) to calculate precision and recall.
